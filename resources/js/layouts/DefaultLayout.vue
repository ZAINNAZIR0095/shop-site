                ...
                <div :class="{ 'has-navbar': showNavbar }">
                    ...
                    <CSidebar class="sidebar-fixed border-end" :visible="sidebarVisible" :unfoldable="sidebarCollapsed"
                        ...
                        <CSidebarNav>
                            ...
                            <!-- Products Link -->
                            <CNavItem>
                                <CNavLink :active="isActiveRoute('/products-list')" @click="navigateTo('/products-list')"
                                    class="d-flex align-items-center  px-0" :class="sidebarCollapsed ? 'px-0' : 'px-2'">
                            ...
                            <!-- Stock Report Link -->
                            <CNavItem>
                                <CNavLink :active="isActiveRoute('/stocks-report')" @click="navigateTo('/stocks-report')"
                                    class="d-flex align-items-center  px-0" :class="sidebarCollapsed ? 'px-0' : 'px-2'">
                    ...
                    <!-- Mobile Overlay -->
                    <div v-if="sidebarVisible && isMobile" class="sidebar-overlay" @click="sidebarVisible = false"></div>
