    ...
    <div class="layout-wrapper">
        ...
        >
            ...
            <CNavItem>
                <CNavLink
                :active="isActiveRoute('/products-list')"
            ...
            <CNavItem>
                <CNavLink
                :active="isActiveRoute('/stocks-list')"
                @click="navigateTo('/stocks-list')"
                class="d-flex align-items-center  px-0"
                >
            ...
            <CNavItem>
                <CNavLink
                :active="isActiveRoute('/stocks-report')"
                @click="navigateTo('/stocks-report')"
                class="d-flex align-items-center  px-0"
                >
            ...
            <CNavItem>
                <CNavLink
                :active="isActiveRoute('/transaction-report')"
                @click="navigateTo('/transaction-report')"
                class="d-flex align-items-center  px-0"
                >
                <CIcon custom-class-name="nav-icon me-2" :icon="cilChart" />
