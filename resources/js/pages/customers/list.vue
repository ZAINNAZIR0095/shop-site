                ...
                <div v-if="selectedCustomer">
                    ...
                    <CTabs>
                        ...
                        <CTabPanels>
                            ...
                            <CTabPanel>
                                <div v-if="transactionsLoading" class="text-center py-4">
                                    <CSpinner />
                                </div>
                                <div v-else-if="customerTransactions.data && customerTransactions.data.length > 0">
                                    <div class="table-responsive">
                                        <table class="table table-sm">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                <tr v-for="transaction in customerTransactions.data"
                                                    ...
                                                    <td class="text-end fw-bold">
                                                        PKR {{ formatCurrency(transaction.running_balance) }}
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
