            ...
            <CCardBody>
                <CForm @submit.prevent="submitForm">
                    ...
                    <div class="mb-3">
                        ...
                        <CFormInput id="name" v-model="form.name" type="text" placeholder="Enter product name"
                            :invalid="errors.name" @input="clearError('name')" />
                    ...
                    <div class="mb-3">
                        ...
                        <CFormSelect id="type" v-model="form.type" :invalid="errors.type" @change="clearError('type')">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <CFormInput id="unit" v-model="form.unit" type="text" placeholder="e.g., kg, liter, piece"
                                :invalid="errors.unit" @input="clearError('unit')" />
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <CFormInput id="size" v-model="form.size" type="text"
                                placeholder="e.g., 500ml, 1kg, 10x10cm" :invalid="errors.size"
                    ...
                    <div class="mb-3">
                        ...
                        <CFormInput id="min_limit" v-model="form.min_limit" type="number" min="0"
                            placeholder="Enter minimum stock limit" :invalid="errors.min_limit"
                    ...
                    <div class="row">
                        <!-- Purchase Price -->
                        <div class="col-md-6 mb-3">
                            <CFormLabel for="purchase_price">Purchase Price <span class="text-danger">*</span>
                            </CFormLabel>
                            <CInputGroup>
                                <CInputGroupText>PKR</CInputGroupText>
                                <CFormInput id="purchase_price" v-model="form.purchase_price" type="number" step="0.01"
                                    min="0" placeholder="0.00" :invalid="errors.purchase_price"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <CInputGroup>
                                <CInputGroupText>PKR</CInputGroupText>
                                <CFormInput id="sale_price" v-model="form.sale_price" type="number" step="0.01" min="0"
                                    placeholder="0.00" :invalid="errors.sale_price"
    ...
    try {
        ...
        if (error.response && error.response.status === 422) {
            ...
            Swal.fire({
                ...
                text: 'A product with this information already exists.',
                icon: 'error'
            })
